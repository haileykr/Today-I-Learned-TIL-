...
Given the size of a 2-dimensional plane (each side n) and actions to build/remove columns/beams
return the final layout of structures!


programmers.co.kr/learn/couses/30/lessons/60061

03/09/21
'''

# check if the remaining structure layout is possible
def possible(answer):
